...
<div class="empty">
	...
	<div class="mainCenter">
		<div class="allCheck">
			<p class="leftM" style="margin-left: 100px">商品</p>
			<p class="rightM" style="margin-left: 400px">单价(元)</p>
			<p class="leftM">数量</p>
		...
		<div class="mainPro">
			...
			<div class="bb">
                ...
                <div class="mm">
                	<span style="margin-left: 15px">¥66.00</span>
                </div>
                <span  style="margin-top:40px;margin-left: 50px">2</span>
                <div class="ri" style="margin-left: 110px">¥66.00元</div>
			</div>
